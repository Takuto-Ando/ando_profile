...
私の学術的関心は、画像処理やAIを活用した実装技術とこれらを支える計算機アーキテクチャにあります。
これらの技術により実社会の課題を解決する実用的なソリューションの開発に取り組んでいます。
...
発表は国内学会・研究会が５回，国際会議が４回の経験があります。
論文は国際会議プロシーディングスも含めて、国際5本、国内1本の研究業績があります。
